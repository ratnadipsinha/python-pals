...
CHAPTERS = [
    ...
    },
    {
        ...
        "puzzles": [
            {"prompt": "Puzzle 1: Make a list  fruits = [\"apple\", \"banana\", \"cherry\"]  and print the FIRST item.",
             "starter": 'fruits = ["apple", "banana", "cherry"]\nprint(fruits[0])', "expect": "apple"},
            {"prompt": "Puzzle 2: Make  nums = [10, 20, 30]  and print the SECOND item.",
             "starter": "nums = [10, 20, 30]\nprint(nums[1])", "expect": "20"},
            {"prompt": "Puzzle 3: Make  pets = [\"cat\", \"dog\", \"fish\"]  and print the LAST item using  pets[2].",
             "starter": 'pets = ["cat", "dog", "fish"]\nprint(pets[2])', "expect": "fish"},
            {"prompt": "Puzzle 4: Make  scores = [5, 10, 15, 20]  and print how many items it has with  len( ).",
             "starter": "scores = [5, 10, 15, 20]\nprint(len(scores))", "expect": "4"},
            {"prompt": "Puzzle 5: Make  colors = [\"red\", \"blue\"]  and print the first item.",
             "starter": 'colors = ["red", "blue"]\nprint(colors[0])', "expect": "red"},
            {"prompt": "Puzzle 6: Make a list  team = [\"Sam\", \"Alex\", \"Jo\"]  and print how many players with  len( ).",
             "starter": 'team = ["Sam", "Alex", "Jo"]\nprint(len(team))', "expect": "3"},
            {"prompt": "Puzzle 7: Make  ages = [8, 9, 10]  and print the THIRD item using  ages[2].",
             "starter": "ages = [8, 9, 10]\nprint(ages[2])", "expect": "10"},
            {"prompt": "Puzzle 8: Make a list of your 3 favorite foods and print the first one.",
             "starter": 'foods = ["pizza", "mango", "pasta"]\nprint(foods[0])', "expect_any": True},
            {"prompt": "Puzzle 9: Make  toys = [\"ball\", \"kite\", \"blocks\", \"puzzle\"]  and print the SECOND item.",
             "starter": 'toys = ["ball", "kite", "blocks", "puzzle"]\nprint(toys[1])', "expect": "kite"},
            {"prompt": "Puzzle 10: Make  nums = [1, 2, 3, 4, 5]  and print its length with  len( ).",
             "starter": "nums = [1, 2, 3, 4, 5]\nprint(len(nums))", "expect": "5"},
            {"prompt": "Puzzle 11: Make  planets = [\"Mars\", \"Venus\", \"Earth\"]  and print the FIRST item.",
             "starter": 'planets = ["Mars", "Venus", "Earth"]\nprint(planets[0])', "expect": "Mars"},
            {"prompt": "Puzzle 12: Make a list of 3 animals and print how many there are with  len( ).",
             "starter": 'animals = ["lion", "tiger", "bear"]\nprint(len(animals))', "expect": "3"},
        ],
    },
    {
    ...
    },
    {
        ...
        "puzzles": [
            {"prompt": "Puzzle 1: Use  range(5)  to print  0 1 2 3 4  each on its own line.",
             "starter": "for i in range(5):\n    print(i)", "expect": "0\n1\n2\n3\n4"},
            {"prompt": "Puzzle 2: Use  range(2, 6)  to print  2 3 4 5.",
             "starter": "for i in range(2, 6):\n    print(i)", "expect": "2\n3\n4\n5"},
            {"prompt": "Puzzle 3: Use  range(1, 10, 2)  to print the odd numbers  1 3 5 7 9.",
             "starter": "for i in range(1, 10, 2):\n    print(i)", "expect": "1\n3\n5\n7\n9"},
            {"prompt": "Puzzle 4: Print  list(range(5))  to see it as a real list.",
             "starter": "print(list(range(5)))", "expect": "[0, 1, 2, 3, 4]"},
            {"prompt": "Puzzle 5: Use  range(3)  to print  Hop  three times.",
             "starter": 'for i in range(3):\n    print("Hop")', "expect": "Hop\nHop\nHop"},
            {"prompt": "Puzzle 6: Use  range(0, 10, 2)  to print the even numbers  0 2 4 6 8.",
             "starter": "for i in range(0, 10, 2):\n    print(i)", "expect": "0\n2\n4\n6\n8"},
            {"prompt": "Puzzle 7: Print  list(range(1, 4))  to see  [1, 2, 3].",
             "starter": "print(list(range(1, 4)))", "expect": "[1, 2, 3]"},
            {"prompt": "Puzzle 8: Use  range(4, 8)  to print  4 5 6 7.",
             "starter": "for i in range(4, 8):\n    print(i)", "expect": "4\n5\n6\n7"},
            {"prompt": "Puzzle 9: Use  range(3, 9, 3)  to print  3  then  6.",
             "starter": "for i in range(3, 9, 3):\n    print(i)", "expect": "3\n6"},
            {"prompt": "Puzzle 10: Use  range(1, 20, 5)  to print  1 6 11 16.",
             "starter": "for i in range(1, 20, 5):\n    print(i)", "expect": "1\n6\n11\n16"},
            {"prompt": "Puzzle 11: Use  range(4)  to print  Star  four times.",
             "starter": 'for i in range(4):\n    print("Star")', "expect": "Star\nStar\nStar\nStar"},
            {"prompt": "Puzzle 12: Print  list(range(0, 10, 3))  to see  [0, 3, 6, 9].",
             "starter": "print(list(range(0, 10, 3)))", "expect": "[0, 3, 6, 9]"},
        ],
    },
    {
    ...
    },
    {
        ...
        "puzzles": [
            {"prompt": "Puzzle 1: Make  greet(name)  print  Hello,  + name, then call  greet(\"Alice\").",
             "starter": 'def greet(name):\n    print("Hello, " + name)\n\ngreet("Alice")', "expect": "Hello, Alice"},
            {"prompt": "Puzzle 2: Make  add(a, b)  print  a + b,  then call  add(3, 5).",
             "starter": "def add(a, b):\n    print(a + b)\n\nadd(3, 5)", "expect": "8"},
            {"prompt": "Puzzle 3: Make  double(n)  print  n * 2,  then call  double(4).",
             "starter": "def double(n):\n    print(n * 2)\n\ndouble(4)", "expect": "8"},
            {"prompt": "Puzzle 4: Make  square(n)  print  n * n,  then call  square(5).",
             "starter": "def square(n):\n    print(n * n)\n\nsquare(5)", "expect": "25"},
            {"prompt": "Puzzle 5: Make  greet(name)  print  Hi  + name, then call it with YOUR name.",
             "starter": 'def greet(name):\n    print("Hi " + name)\n\ngreet("Sam")', "expect_any": True},
            {"prompt": "Puzzle 6: Make  subtract(a, b)  print  a - b,  then call  subtract(10, 3).",
             "starter": "def subtract(a, b):\n    print(a - b)\n\nsubtract(10, 3)", "expect": "7"},
            {"prompt": "Puzzle 7: Make  shout(word)  print  word + \"!\",  then call  shout(\"Go\").",
             "starter": 'def shout(word):\n    print(word + "!")\n\nshout("Go")', "expect": "Go!"},
            {"prompt": "Puzzle 8: Make  add3(a, b, c)  print  a + b + c,  then call  add3(1, 2, 3).",
             "starter": "def add3(a, b, c):\n    print(a + b + c)\n\nadd3(1, 2, 3)", "expect": "6"},
            {"prompt": "Puzzle 9: Make  multiply(x, y)  RETURN  x * y,  then print  multiply(4, 6).",
             "starter": "def multiply(x, y):\n    return x * y\n\nprint(multiply(4, 6))", "expect": "24"},
            {"prompt": "Puzzle 10: Make  intro(name, age)  print name then age, and call  intro(\"Max\", 9).",
             "starter": 'def intro(name, age):\n    print(name)\n    print(age)\n\nintro("Max", 9)', "expect": "Max\n9"},
            {"prompt": "Puzzle 11: Make  triple(n)  print  n * 3,  then call  triple(5).",
             "starter": "def triple(n):\n    print(n * 3)\n\ntriple(5)", "expect": "15"},
            {"prompt": "Puzzle 12: Make  add(a, b)  RETURN  a + b,  then print  add(2, 2).",
             "starter": "def add(a, b):\n    return a + b\n\nprint(add(2, 2))", "expect": "4"},
        ],
    },
]
